...
PUSH_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional("command_feedback"): cv.string,
        vol.Optional("command_name"): cv.string,
        vol.Optional("command_detail_key"): cv.string,
        vol.Optional("command_detail_arg"): cv.string,
        vol.Optional("command_at"): cv.string,
